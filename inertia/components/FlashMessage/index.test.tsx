...
describe(FlashMessage, () => {
  it('displays a flash message', () => {
    const { getByText } = render(<FlashMessage variant="danger">Message</FlashMessage>)
  ...
  it('is dismissable', async () => {
    const { getByRole, getByText } = render(<FlashMessage variant="danger">Message</FlashMessage>)
